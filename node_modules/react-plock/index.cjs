...
const useSafeLayoutEffect = isBrowser ? React__namespace.useLayoutEffect : React__namespace.useEffect;
...
const Plock = _a => {
  ...
  useSafeLayoutEffect(() => {
    ...
    React__namespace.Children.forEach(children, (child, index) => {
      ...
      if ( /*#__PURE__*/React__namespace.isValidElement(child)) {
        const cloned = /*#__PURE__*/React__namespace.cloneElement(child, Object.assign(Object.assign({}, child.props), {
          key: key
        }));
  ...
  return jsxRuntime.jsx(Masonry, Object.assign({
    columns: columns.length,
    gap: gap
  }, props, {
    children: columns.map((column, index) => {
      return jsxRuntime.jsx(MasonryColumn, Object.assign({
        gap: gap,
